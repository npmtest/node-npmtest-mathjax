...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-mathjax/node_modules/mathjax/unpacked/extensions/MathML/mml3.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-mathjax/node_modules/mathjax/unpacked/extensions/MathML/mml3.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">2.33% <small>(1 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-mathjax/node_modules/mathjax/unpacked/extensions/MathML/</a> &#187; mml3.js</div>
</div>
<div class="body">
...
784
785
786</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  MATHML.prefilterHooks.Add(<span class="fstat-no" title="function not covered" >function (data) {</span></span>
<span class="cstat-no" title="statement not covered" >    if (!MATHML.mml3XSLT) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
    // Parse the &lt;math&gt; but use MATHML.Parse's preProcessMath to apply the normal preprocessing.
<span class="cstat-no" title="statement not covered" >    if (!MATHML.ParseXML) {<span class="cstat-no" title="statement not covered" >MATHML.ParseXML = MATHML.createParser()}</span></span>
<span class="cstat-no" title="statement not covered" >    var doc = MATHML.ParseXML(PARSE.preProcessMath(data.math));</span>
&nbsp;
    // Now transform the &lt;math&gt; using the mml3 stylesheet.
<span class="cstat-no" title="statement not covered" >    var newdoc = MATHML.mml3XSLT.transformToDocument(doc);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if ((typeof newdoc) === "string") {</span>
      // Internet Explorer returns a string, so just use it.
<span class="cstat-no" title="statement not covered" >      data.math = newdoc;</span>
    } else <span class="cstat-no" title="statement not covered" >if (window.XMLSerializer) {</span>
...
<span class="cstat-no" title="statement not covered" >      var serializer = new XMLSerializer();</span>
<span class="cstat-no" title="statement not covered" >      data.math = serializer.serializeToString(newdoc.documentElement, doc);</span>
    }
  });
&nbsp;
  /*
   ...
   */
<span class="cstat-no" title="statement not covered" >  var BROWSER = MathJax.Hub.Browser;</span>
<span class="cstat-no" title="statement not covered" >  var exslt = '';</span>
<span class="cstat-no" title="statement not covered" >  if (BROWSER.isEdge || BROWSER.isMSIE) {</span>
<span class="cstat-no" title="statement not covered" >    exslt = 'urn:schemas-microsoft-com:xslt'</span>
  } else {
<span class="cstat-no" title="statement not covered" >    exslt = 'http://exslt.org/common';</span>
  }
<span class="cstat-no" title="statement not covered" >  var mml3Stylesheet =</span>
...
&nbsp;
   ...
   */
&nbsp;
<span class="cstat-no" title="statement not covered" >  var mml3;</span>
<span class="cstat-no" title="statement not covered" >  if (window.XSLTProcessor) {</span>
    // standard method: just use an XSLTProcessor and parse the stylesheet
<span class="cstat-no" title="statement not covered" >    if (!MATHML.ParseXML) {<span class="cstat-no" title="statement not covered" >MATHML.ParseXML = MATHML.createParser()}</span></span>
<span class="cstat-no" title="statement not covered" >    MATHML.mml3XSLT = new XSLTProcessor();</span>
<span class="cstat-no" title="statement not covered" >    MATHML.mml3XSLT.importStylesheet(MATHML.ParseXML(mml3Stylesheet));</span>
  } else <span class="cstat-no" title="statement not covered" >if (MathJax.Hub.Browser.isMSIE) {</span>
    // nonstandard methods for Internet Explorer
<span class="cstat-no" title="statement not covered" >    if (MathJax.Hub.Browser.versionAtLeast("9.0") || (document.documentMode||0) &gt;= 9) {</span>
      // For Internet Explorer &gt;= 9, use createProcessor
<span class="cstat-no" title="statement not covered" >      mml3 = new ActiveXObject("Msxml2.FreeThreadedDOMDocument");</span>
<span class="cstat-no" title="statement not covered" >      mml3.loadXML(mml3Stylesheet);</span>
<span class="cstat-no" title="statement not covered" >      var xslt = new ActiveXObject("Msxml2.XSLTemplate");</span>
<span class="cstat-no" title="statement not covered" >      xslt.stylesheet = mml3;</span>
<span class="cstat-no" title="statement not covered" >      MATHML.mml3XSLT = {</span>
        mml3: xslt.createProcessor(),
        transformToDocument: <span class="fstat-no" title="function not covered" >function(doc) {</span>
<span class="cstat-no" title="statement not covered" >          this.mml3.input = doc;</span>
<span class="cstat-no" title="statement not covered" >          this.mml3.transform();</span>
<span class="cstat-no" title="statement not covered" >          return this.mml3.output;</span>
        }
      }
    } else {
      // For Internet Explorer &lt;= 8, use transformNode
<span class="cstat-no" title="statement not covered" >      mml3 = MATHML.createMSParser();</span>
<span class="cstat-no" title="statement not covered" >      mml3.async = false;</span>
<span class="cstat-no" title="statement not covered" >      mml3.loadXML(mml3Stylesheet);</span>
<span class="cstat-no" title="statement not covered" >      MATHML.mml3XSLT = {</span>
        mml3: mml3,
        transformToDocument: <span class="fstat-no" title="function not covered" >function(doc) {</span>
<span class="cstat-no" title="statement not covered" >          return doc.documentElement.transformNode(this.mml3);</span>
        }
      }
    }
  } else {
    // No XSLT support. Do not change the &lt;math&gt; content.
<span class="cstat-no" title="statement not covered" >    MATHML.mml3XSLT = null;</span>
  }
  
  // Tweak CSS to avoid some browsers rearranging HTML output
<span class="cstat-no" title="statement not covered" >  MathJax.Ajax.Styles({</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  MathJax.Hub.Startup.signal.Post("MathML mml3.js Ready");</span>
});
&nbsp;
<span class="cstat-no" title="statement not covered" >MathJax.Ajax.loadComplete("[MathJax]/extensions/MathML/mml3.js");</span>
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
</div>
